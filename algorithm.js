/*
 * Problem: for a refrigerator software coded in JavaScript, it is required to write a
 * program that manages the quantity of bananas in it and take actions accordingly.
 * Entities:
 * Refrigerator
 * Fruits
 * Person
